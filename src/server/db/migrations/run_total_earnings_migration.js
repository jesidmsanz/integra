...
async function runMigration() {
  try {
    console.log('🔄 Iniciando migración para agregar columna total_earnings...');
    ...
    const migrationPath = path.join(__dirname, '20250131000001-add-total-earnings-to-liquidation-details.sql');
    ...
    console.log('🎉 La columna total_earnings ha sido agregada a liquidation_details');
    ...
    if (result.rows.length > 0) {
      console.log('\n📊 Columna total_earnings verificada:');
