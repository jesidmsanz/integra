...
import {
  ValidationFormStateList,
  ValidationRadioList,
  ValidationStateList,
} from "@/Data/Form&Table/Form/FormData";

export const FormValidations = ({ errors, submitErrors, setSubmitError }) => {
  return (
        ...
        <Col sm="12">
          <FormGroup>
            ...
            <Field
              ...
              placeholder={MarkFirstNamePlaceholder}
            />
            <ErrorMessage
              name="firstname"
              component="span"
        ...
        <Col sm="12">
          <FormGroup>
            ...
            <Field
              ...
              as="select"
              className={`form-control ${
                submitErrors && `${errors.state ? "is-invalid" : "is-valid"}`
              }`}
            >
        ...
        <Col md="6">
          <FormGroup>
            ...
            <Field
              ...
              type="text"
              className={`form-control ${
                submitErrors && `${errors.zip ? "is-invalid" : "is-valid"}`
              }`}
            />
            <ErrorMessage
              name="zip"
                ...
                {ValidationRadioList.map(({ id, text }, index) => (
                  <FormGroup check key={index}>
                    <Field
                      ...
                      id={`validationFormCheck${id}`}
                      type="radio"
                      name="payment"
                      value={text}
                    />
                    <Label
                      htmlFor={`validationFormCheck${id}`}
                      className={`${
                        submitErrors &&
                        ` ${errors.payment ? "text-danger" : "text-success"}`
                      }`}
                      check
                    >
                      {text}
          ...
          <FormGroup>
            <Field
              ...
              className={`form-select ${
                submitErrors && `${errors.theme ? "is-invalid" : "is-valid"}`
              }`}
            >
        ...
        <Col sm="12">
          <FormGroup>
            ...
            <Field
              name="file"
              className={`form-control ${
                submitErrors && `${errors.file ? "is-invalid" : "is-valid"}`
              }`}
              type="file"
            />
            <ErrorMessage
        ...
        <Col sm="12">
          <FormGroup check>
            <Field
              ...
              className={`form-check-input ${
                submitErrors &&
                ` ${errors.terms ? "text-danger" : "text-success"}`
              }`}
              id="invalidCheck"
              type="checkbox"
