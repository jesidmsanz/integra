...
import {
  InstagramAnimated,
  WhatIsYourFavoriteSocialMedia,
} from "@/Constant/constant";
import { Fragment } from "react";
import { AnimatedSocialData } from "@/Data/Form&Table/Form/FormData";

export const AnimatedCheckbox = () => {
  return (
    <Col sm="6">
      <div className="card-wrapper border rounded-3 checkbox-checked custom-favorite-media ">
