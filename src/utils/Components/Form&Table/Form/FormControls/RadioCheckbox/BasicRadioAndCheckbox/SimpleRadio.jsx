...
import {
  ...
  BasicRadioAndCheckboxSimpleRadios,
} from "@/Constant/constant";
import { BasicRadioDataList } from "@/Data/Form&Table/Form/FormData";
      ...
      <div className="card-wrapper border rounded-3 checkbox-checked">
        ...
        <div className="form-check-size">
          ...
          {BasicRadioDataList.map(({ id, text }, index) => (
            <div
              className="form-check form-check-inline radio radio-primary"
              key={index}
            >
