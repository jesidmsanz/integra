...
import { BorderedCheckbox, PrimaryCheckboxPrimary } from "@/Constant/constant";
import { BorderCheckboxData } from "@/Data/Form&Table/Form/FormData";
      ...
      <div className="card-wrapper border rounded-3 h-100 checkbox-checked">
        ...
        <div className="form-check checkbox checkbox-primary mb-0">
          ...
          <Label htmlFor="checkbox-primary-1" check>
            {PrimaryCheckboxPrimary}
          </Label>
        </div>
        {BorderCheckboxData.map(({ color, text }, index) => (
          <div
            className={`form-check checkbox checkbox-${color} mb-0`}
            key={index}
          >
