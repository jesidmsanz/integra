...
import { OfferBorderStyleDataList } from "@/Data/Form&Table/Form/FormData";
  ...
  return (
    <Form className="mega-inline offer-style">
      <Row className="flex-column">
        {OfferBorderStyleDataList.map(
          ({ id, color, image, spanText, check }, index) => (
            <Col xs="12" key={index}>
              <Card>
                        ...
                        <span className="d-flex list-behavior-1">
                          <span className="flex-shrink-0">
                            <Image
                              ...
                              width={158}
                              height={86}
                              className="tab-img b-r-0 img-fluid"
                              src={`${ImagePath}/${image}`}
                              alt="image"
                            />
                          </span>
