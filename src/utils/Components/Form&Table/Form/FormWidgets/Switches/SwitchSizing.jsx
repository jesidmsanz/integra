...
import { SwitchSizings } from "@/Constant/constant";
import { CommonCardHeader } from "@/Components/General/Widgets/Common/CommonCardHeader";
import {
  SwitchSizingData,
  SwitchSizingDataList,
  ...
  return (
    <Col md="12">
      <Card>
        <CommonCardHeader
          title={SwitchSizings}
          subTitle={SwitchSizingData}
          headClass="pb-0"
        />
        <CardBody className="common-flex switch-wrapper">
          {SwitchSizingDataList.map(
            ({ label, flexClass, defaultChecked, disabled }, index) => (
