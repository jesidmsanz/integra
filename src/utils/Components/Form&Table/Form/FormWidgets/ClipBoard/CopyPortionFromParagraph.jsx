...
const CopyPortionFromParagraph = () => {
  const [highlightTextValue, setHighlightTextValue] = useState({
    value: "Web design is the process of creating websites",
    copied: false,
  });
  return (
    <Col sm="12" md="6">
        ...
        <CardBody>
          <div className="clipboaard-container">
            ...
            <div className="mt-3 text-end">
              <CopyToClipboard
                text={highlightTextValue.value}
                onCopy={(value) =>
                  setHighlightTextValue({ value, copied: true })
                }
              >
