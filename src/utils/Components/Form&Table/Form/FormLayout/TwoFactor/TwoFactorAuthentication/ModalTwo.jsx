...
import {
  setActive,
  setModalTwo,
} from "@/Redux/Reducers/FormLayout/TwoFactorSlice";
...
const ModalTwo = () => {
  ...
  return (
    <Modal centered isOpen={modalTwo} toggle={() => dispatch(setModalTwo())}>
      <ModalHeader toggle={() => dispatch(setModalTwo())}>
        {ScanQRCode}
      </ModalHeader>
      <ModalBody className="main-qr-code">
        <div className="modal-toggle-wrapper">
          <p>
            ...
            authenticator, OTP xyz, or pqr authenticator. You must input the
            six-digit code it generates below.
          </p>
          <div className="modal-img">
            <div className="qr-img">
              <Image
                ...
                width={100}
                height={100}
                src={`${ImagePath}/forms/qr-code.png`}
                alt="qr-code"
              />
            </div>
            <div className="qr-content">
              <div
                className={`alert alert-light-dark light alert-dismissible fade text-dark border-left-wrapper ${
                  active ? "show" : "d-none"
                }`}
                role="alert"
              >
                ...
                <div>
                  <span>
                    If your qr code is not working then enter this code in your
                    input field.
                  </span>
