...
import { ProceedNext } from "@/Constant/constant";
import { ShippingMethodData } from "@/Data/Form&Table/Form/FormData";

const ShippingMethods = ({ radioBoxValues, getUserData, handleNextButton }) => {
          ...
          <div className="card-wrapper border rounded-3 h-100 light-card">
            <FormGroup check className="radio radio-primary">
              <Input
                ...
                name="shippingMethod"
                value={data.value}
                checked={shippingMethod === data.value}
