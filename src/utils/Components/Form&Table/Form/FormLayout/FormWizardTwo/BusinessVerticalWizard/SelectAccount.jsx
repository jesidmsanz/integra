...
import { AccountType, Continue } from "@/Constant/constant";
...
import { SelectAmountData } from "@/Data/Form&Table/Form/FormData";

const SelectAccount = ({ callbackActive }) => {
    ...
    >
      <Row>
        <Col xs="12" className="mt-2">
          <h5>{AccountType}</h5>
          <p>
            It has long been known that distracting information on a page will
            lose a readers attention.
          </p>
        </Col>
        <Col xs="12" className="mt-2">
              ...
              {SelectAmountData.map((data, index) => (
                <li key={index}>
                  <Input
                    id={data.title}
                    value={data.title}
                    checked={data.title === accountType}
                    type="radio"
                    name="accountType"
                  ...
                  <Label className="mb-0" htmlFor={data.title} check>
                    ...
                    <span className="d-flex flex-column">
                      ...
                      <span>
                        Search your {data.title} information please check it
                      </span>
                    </span>
                  </Label>
                </li>
