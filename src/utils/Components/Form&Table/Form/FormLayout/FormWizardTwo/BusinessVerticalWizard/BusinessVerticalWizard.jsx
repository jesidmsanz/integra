...
const BusinessVerticalWizard = ({
  ...
  const callback = useCallback((tab) => setActiveTab(tab), []);
  ...
  return (
    <Col sm="12">
      <Card>
        ...
        <CardBody>
          <div
            className={`horizontal-wizard-wrapper  vertical-variations ${
              horizontalWizardClass ? horizontalWizardClass : ""
            }`}
          >
            <Row className="g-3">
              ...
              <Col xs={xs} xl={secondXl}>
                <BusinessVerticalWizardTabContent
                  activeTab={activeTab}
