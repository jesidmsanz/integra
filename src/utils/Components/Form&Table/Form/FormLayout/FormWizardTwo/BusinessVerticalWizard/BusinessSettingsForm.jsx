...
const BusinessSettingsForm = ({ callbackActive }) => {
  const { businessSettingsFormValues } = useAppSelector(
    (state) => state.formWizardTwo
  );
        ...
        <Col xs="12">
          <section className="main-upgrade">
            <div>
              ...
              <h5 className="mb-2">
                {SelectTeamWith}
                <span className="txt-primary ms-1">{Projects}</span>
              </h5>
              <p className="text-muted mb-2">
                Agile teams are cross-functional and made up of 5-11 on a
                regular basis team member.
              </p>
            </div>
            <VariationBox />
          </section>
