...
import {
  ...
  OrganizationName,
  Previous,
  ShareYourProblemsAndAnotherIssues,
...
const ContactDetailsForm = ({ callbackActive }) => {
  const SelectData = [
    "Technology",
    "Culture",
    "NGO",
  ...
  const { contactDetailsFormValues } = useAppSelector(
    ...
    >
      <Row>
        <Col xs="12">
          ...
          <p>
            Please visit the documentation page if you require further
            information.
          </p>
        </Col>
        ...
        <Col xs="12">
          <FormGroup>
            ...
            <Input
              ...
              name="description"
              onChange={getUserData}
              placeholder={ShareYourProblemsAndAnotherIssues}
            />
          </FormGroup>
        </Col>
