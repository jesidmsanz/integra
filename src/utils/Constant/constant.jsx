...
export const ThemePrimary = "var(--theme-default)";
export const ThemeSecondary = "var(--theme-secondary)";
...
export const SearchDunzo = "Search Dunzo ..";
...
export const AdminUsersTitle = "Users";

//Default-Dashboards
export const DashboardTitle = "Dashboard";
export const DefaultDashboardTitle = "Default Dashboard";
export const DefaultTitle = "Default";
export const HelloRamirez = "Hello, Ramirez";
export const ViewProfile = "View Profile";
export const ThanLastWeek = "than last week";
export const NewsUpdateTitle = "News & Update";
export const MinAgo = "Min ago";
export const ProductStockTitle = "Product Stock";
export const TotalProductStock = "Total Product Stock";
export const RecentOrderTitle = "Recent Order";
export const SalesStatisticTitle = "Sales Statistic";
export const ViewCount = "View Count";
export const SeeMore = "See more";
export const SinceLastWeek = "Since last Week";
export const ReviewTitle = "Review";
export const SalesOverviewTitle = "Sales Overview";
export const ActiveTasksTitle = "Active Tasks";
export const TotalInvestmentTitle = "Total Investment";
export const LeadsStatusTitle = "Leads Status";
export const StatisticsTitle = "Statistics";
export const WeeklyTarget = "Weekly Target";
export const MonthlyTarget = "Monthly Target";

//Ecommerce-Dashboard
export const EcommerceDashboardTitle = "Ecommerce Dashboard";
export const ECommerceTitle = "E-Commerce";
export const Feedback = "Feedback";
export const SalesEventCalendarTitle = "Sales Event Calendar";
export const SetSalesEvents = "Set Sales Events";
export const Discount = "Discount";
export const SaleTopCountriesTitle = "Sale Top Countries";
export const CategoriesBySalesTitle = "Categories by Sales";
export const TotalEarned = "Total Earned";
export const SaleStatisticTitle = "Sale Statistic";
export const OrderOverviewTitle = "Order Overview";
export const TotalRevenue = "Total Revenue";
export const MonthlySaleTitle = "Monthly Sale";
export const Growth = "Growth";
export const InvoicesTitle = "Invoices";
export const Due = "Due";
export const Overdue = "Overdue";
export const Unlock = "UNLOCK";
export const RecentActivityTitle = "Recent Activity";
export const NewCustomersTitle = "New Customers";
export const SpecialDiscount = "Special Discount";
export const DealOfTheDay = "Deal of the  Day From";

//Project-Dashboard
export const ProjectDashboardTitle = "Project Dashboard";
export const ProjectTitle = "Project";
export const ProgressTitle = "Progress";
export const ProjectSummaryTitle = "Project Summary";
export const UpcomingLaunchTitle = "Upcoming Launch App";
export const DunzoAppLaunch = "Dunzo App Launch";
export const SetReminder = "Set Reminder";
export const DesignCardTitle = "WE ARE DESIGN AGENCY WORK WITH YOU";
export const HireUs = "Hire Us";
export const BudgetCardTitle = "Budget";
export const BudgetSpent = "Budget Spent";
export const ProjectCreatedTitle = "Project Created";
export const TodayTasksTitle = "Today’s Tasks";
export const ProgressCardTitle = "Workload Dashboard For CMS Website";
export const Projects = "Projects";
export const UpcomingProjectsTitle = "Upcoming Projects";
export const UpcomingMeetingTitle = "Upcoming Meeting";
export const TodaySanFransico = "Today san Fransico,CA";

//General-Widget
export const GeneralTitle = "General";
export const WidgetsTitle = "Widgets";

//Chart-Widget
export const ChartTitle = "Chart";
export const CompareLastMonth = "Compare to last month";
export const Today = "Today";
export const MonthlyHistoryTitle = "Monthly History";
export const LiveProductsTitle = "Live Products";
export const TurnOverTitle = "Turn over";
export const StockMarketTitle = "Stock Market";
export const Progress = "Progress";

//Project - Applications
export const AppsTitle = "Apps";
...
export const FileManagerTitle = "File Manager";
...
export const Free = "FREE";
export const PricingPlanText = "Pricing Plan";
export const StorageText = "Storage";

//Email App - Applications
export const EmailTitle = "Email";
export const EmailApplicationTitle = "Email Application";
export const EmailFilter = "email filter";
export const Markjenco = "MARKJENCO";
export const MarkjencoMail = "Markjecno@gmail.com";
...
export const CommentsSocialPlaceholder = "Post Your comments";
...
export const EducationAndEmploymentHeading = "Education and Employment";
...
export const DefaultCheckboxTitle = "Default checkbox";
export const DefaultCheck = "Default Checks";
export const DefaultCheckboxLabel = "Default checkbox";
...
export const CustomCheckboxTitle = "Custom checkbox";
...
export const ImagesWithCheckboxTitle = "Images with checkbox";
...
export const BasicRadioAndCheckboxTitle = "Basic radio and checkbox";
...
export const VariationCheckboxTitle = "Variation checkbox";
...
export const FormWidgets = "Form Widgets";

//Form Widgets - Touchspin
export const Touchspin = "Touchspin";
export const DefaultTouchspinTitle = "Default touchspin";
export const OutlinedTouchspinTitle = "Outlined touchspin";
export const IconsWithPrefixAndPostfixTitle = "Icons with prefix and postfix";
export const ButtonsWithPrefixAndPostFixTitle =
...
export const IconsSwitches = "Icons switch";
...
export const VariationOfSwitchesTitle = "Variation of switches";
...
export const BasicTypeAheadTitle = "Basic typeahead";
...
export const LinkedInPlaceholder = "https://linkedIn.com/dunzo";
export const GitHubPlaceholder = "https://github.com/dunzo";
export const TwitterPlaceholder = "https://twitter.com/dunzo";
...
export const DunzoMail = "dunzo@example.com";
export const AdharaPlaceholder = "xxxx xxxx xxxx xxxx";
...
export const InverseTableWithPrimaryBackgrounds =
...
export const ReactstrapTable = "Reactstrap Tables";
export const ZeroConfiguration = "Zero Configuration";
export const SearchTableButton = "Buscar";
...
export const APIDataTables = "API Data Tables";
...
export const EmText = "This line rendered as italicized text.";
...
export const ShapesTitle = "Shapes";
...
export const AdditivesRadius = "Additive Radius";
...
export const OpenModalForDunzo = "Open modal for Dunzo";
...
export const DunzoCustomModal = "Dunzo Custom Modals ";
export const BalanceAmount = "$768,987.90";
export const Close = "Close";
export const SaveChanges = "Save changes";
export const ClickOut = "Click Out";
export const DunzoSignUp = "Dunzo SIGN-UP";
export const DunzoLogin = "Dunzo Login";
...
export const TooltipInfo = "Tooltip Info";
...
export const UniqueDropdownTitle = "Unique Dropdown";
...
export const DunzoProfilesForNewEmployees = "Dunzo Profiles For New Employees:";
...
export const ListsWithCheckboxTitle = "Lists With Checkbox";
...
export const AutoCloseTimerTitle = "Auto Close Timer";

//Bonus Ui - OwlCarousel
export const ReactstrapCarousel = "Reactstrap Carousel";
...
export const DisableTouchSwipingTitle = "Disable Touch Swiping";
...
export const DefaultPaginationTitle = "Default Pagination";
...
export const RoundedPaginationTitle = "Rounded Pagination";
...
export const BreadcrumbsTag = "Breadcrumb";
...
export const FormattedLabels = "Formatted Label";
...
export const DunzoTheme = "Dunzo Theme";
...
export const TeresaMoselles = "Teresa J. Moselles";
...
export const OfwrriorCompany = "Ofwrrior Company";
...
// Buttons
export const ButtonsTitle = "Buttons";
export const DefaultStyleTitle = "Default Style";
export const DefaultButtonTitle = "Default buttons";
export const FlatButtonTitle = "Flat button";
export const RaisedButtonTitle = "Raised with Edge buttons";
export const SizingButtonsTitle = "Sizing buttons";
export const ActiveButtonsTitle = "Active Buttons";
export const DisabledButtonsTitle = "Disabled buttons";
export const OutlineButtonsTitle = "Outline buttons";
export const BoldBorderOutlineButtonsTitle = "Bold Border outline buttons";
export const GradienButtonsTitle = "Gradien buttons";
export const ButtonGroupTitle = "Button Group";
export const Option1 = "Option 1";
export const Option2 = "Option 2";
export const NestingTitle = "Nesting";
export const DropdownText = "Dropdown";
export const DropdownLink = "Dropdown link";
export const VerticalTitle = "Vertical";
export const ButtonHeading = "Button";

// Charts
export const ChartsTitle = "Charts";
export const ApexChartTitle = "Apex Chart";
export const BasicAreaChartTitle = "Basic Area Chart";
export const AreaSpalineChartTitle = "Area Spaline Chart";
export const ColumnChartTitle = "Column Chart";
export const BubbleChartTitle = "3d Bubble Chart";
export const SteplineChartTitle = "Stepline Chart";
export const PieChartTitle = "Pie Chart";
export const DonutChartTitle = "Donut Chart";
export const MixedChartTitle = "Mixed Chart";
export const CandlestickChartTitle = "Candlestick Chart";
export const RadarChartTitle = "Radar Chart";
export const RadialBarChartTitle = "Radial Bar Chart";
export const AreaChartTitle1 = "Area Chart 1";
export const AreaChartTitle2 = "Area Chart 2";
export const ColumnChartTitle1 = "Column Chart 1";
export const ColumnChartTitle2 = "Column Chart 2";
export const GanttChartTitle = "Gantt Chart";
export const LineChartTitle = "Line Chart";
export const ComboChartTitle = "Combo Chart";
export const BarChart2Title = "Bar-chart2";
export const WordTreeTitle = "Word Tree";
export const PieChart = "Pie Chart";
export const ChartJsChartTitle = "ChartJS Chart";
export const BarChartTitle = "Bar Chart";
export const LineGraphTitle = "Line Graph";
export const RadarGraphTitle = "Radar Graph";
export const DoughnutChartTitle = "Doughnut Chart";
export const PolarChartTitle = "Polar Chart";
export const GoogleChartTitle = "Google Chart";
...
export const SignInToAccount = "Administrador";
export const EmailAddressLogIn = "Email";
export const RememberPassword = "Recordar";
...
export const EnterYourPersonalDetailsToCreateAccount =
  "Enter your personal details to create account";
export const YourNameSignUp = "Your Name";
export const EmailAddressSignUp = "Email";
export const PasswordSignUp = "Contraseña";
...
export const MaintenancesSubContent =
...
export const EnterYourEmailPasswordToLoginWizard =
  "Digite su usuario y contraseña para ingresar al administrador";
export const FirstNameWizard = "First Name";
export const LastNameWizard = "Last Name";
export const ContactNameWizard = "Contact No.";
export const FirstNameWizardPlaceholder = "John";
...
export const SingleBlogHeading = `The Harped rises in the westernmost part of Rutherford County, just to the east of the community of College Grove in eastern Williamson County.`;
...
export const JobEndlessTelecomTechnologies =
...
export const DisplayCategory = "Display Category";
...
export const AllowBackOrders = "Allow Back orders";
...
export const ModalMensText =
  "Lorate Solid Men's Fashion Full Sleeves Latest Jacket for Men With Button Closure Long Sleeve Casual Torn Lycra Denim Jacket.";
export const ModalLongText =
  "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.";
export const ModalRavaiyaaText =
  "Ravaiyaa - Attitude is everything Cotton Men's Dresses One Top Button T-Shirt.";
export const ModalRockText =
...
// Empleados-Dashboard
export const DirectoryTitle = "Empleados";
export const AddDoctor = "Agregar Empleado";
export const Directory = "Empleados";
// export const DirectoryList = "Todo el Empleados";
export const MedicalProfile = "Perfil Empleado";
